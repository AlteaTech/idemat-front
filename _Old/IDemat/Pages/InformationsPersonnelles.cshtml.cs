...
{
    public class InformationsPersonnellesModel : PageModel
    {
        private readonly IDemat.Data.IDematContext _context;
        private IWebHostEnvironment _environment;
        private readonly IConfiguration _config;

        public InformationsPersonnellesModel(IDemat.Data.IDematContext context, IWebHostEnvironment environment, IConfiguration config)
        {
            _context = context;
        ...
        public IActionResult OnGet(string usagerGuid, bool deconnect)
        {
