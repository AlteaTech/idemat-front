...
{
    public class DechetteriesModel : PageModel
    {
        private readonly IDemat.Data.IDematContext _context;
        private IWebHostEnvironment _environment;
        private readonly IConfiguration _config;

        public DechetteriesModel(IDemat.Data.IDematContext context, IWebHostEnvironment environment, IConfiguration config)
        {
            _context = context;
        ...
        public IQueryable<Dechetterie> MesDechetteries { get; set; }
        ...
        public IActionResult OnGet(string usagerGuid)
        {
            ...
            try
            {
                ...
                if (Variables.usageractif != null)
                {
                    ...
                    MesDechetteries = _context.Dechetteries.Where(d => d.IdEnseigne == Variables.usageractif.IdEnseigne);
